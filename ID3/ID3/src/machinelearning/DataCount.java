...
/**
 * @param ageSplit : Since age is a continous value, we split it according to this parameter which we calculated using Gini Co-efficient
 * @param fnlSplit : Since fnlwgt is a continous value, we split it according to this parameter which we calculated using Gini Co-efficient
 * @param eduNumSplit : Since eduNum is a continous value, we split it according to this parameter which we calculated using Gini Co-efficient
 * @param capGainSplit : Since capGain is a continous value, we split it according to this parameter which we calculated using Gini Co-efficient
 * @param capLossSplit : Since capLoss is a continous value, we split it according to this parameter which we calculated using Gini Co-efficient
 * @param hoursSplit : Since hoursSplit is a continous value, we split it according to this parameter which we calculated using Gini Co-efficient
 ...
 */
public void updateValues(int ageSplit,int fnlSplit,int eduNumSplit,int capGainSplit,int capLossSplit,int hoursSplit,ArrayList<DataSet> data)
{
